...
export default function Home() {
    ...
    return (
        <main className="bg-white text-gray-800">
            ...
            {/* Philosophy Section */}
            <section id="philosophy" className="bg-gray-200 py-12 px-8 text-center">
            ...
            <section id="director" className="py-12 px-8">
                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    />
                    <div>
                        <h3 className="text-xl font-bold text-black">Spofana ML</h3>
            ...
            {/* Contact Section */}
            <section id="contact" className="bg-black text-white py-12 px-8 text-center">
